...
export class InAppBrowserDetector {
    ...
    static detectWebView(userAgent) {
        ...
        if (userAgent.includes('edg') || userAgent.includes('edge/'))
            return false;
        if (userAgent.includes('brave') || (braveNav.brave && typeof braveNav.brave.isBrave === 'function'))
            return false;
    ...
    static getBrowserName() {
        ...
        if (userAgent.includes('crios'))
            return 'Chrome';
        if (userAgent.includes('chrome') && !userAgent.includes('wv'))
            return 'Chrome';
        if (userAgent.includes('firefox'))
            return 'Firefox';
        if (userAgent.includes('safari') && !userAgent.includes('chrome') && !userAgent.includes('crios') && !userAgent.includes('wv') && !/gsa\//i.test(userAgent))
            return 'Safari';
        if (userAgent.includes('opera') || userAgent.includes('opr/'))
            return 'Opera';
        if (userAgent.includes('vivaldi'))
